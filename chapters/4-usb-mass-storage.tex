\chapter{Interlude: USB Mass Storage}
    ...
    \section{USB mass storage device class}
        ...
        Particularly high performance mass storage devices tend to use the SCSI standard\cite{usb-electronicdesign-usb-uasp-bot}, but because USB Attached SCSI protocol (UASB) was only specified when USB 3.0 was introduced, few devices have adopted it so far\cite{usb-winaero-usb-scsi-uas}.
