\chapter{Analysis of Possible Solutions}
    ...
    \section{Hardware Options}
        ...
        \subsection{Raspberry Pi}
            ...
            The Raspberry Pi is open hardware with the exception of the Broadcom SoC\footnote{System on a Chip} containing the video core.  For an operating system, many Linux distributions provide support \cite{rpi-opensource}.  Being a computer running a full operating system, support for acting as a USB host device comes naturally.
