...
%        \todo{A prototype will be built.  This should probably include pictures and a short description of the process}
        ...
        \imagefigure{photos/fedorator-prototype-test-print.jpg}
        ...
        Due to the printer's size, the height of this prototype had to be lowered to 172~cm and each part was printed individually.  Each part took about ten hours to print.% \todo{exact numbers?}
        
        \imagefigure{photos/fedorator-case-supports.jpg}
        ...
        \idkijustwanttwotofitonapagefigure{photos/fedorator-ready.jpg}
            {The Fedorator prototype with a USB flash drive plugged in}
            
        \idkijustwanttwotofitonapagefigure{photos/fedorator-done.jpg}
    ...
    \section{Speed Measurements}
        To test performance in different situations, I have measured how long the Fedorator takes to write the Fedora Workstation Live image (1.34~GiB) to several different flash drives.  Several measurements were done in order to gain the average.  There was negligible deviation.
       ...
       SONY USB2.0              & 15.80~GiB & 6~m~07~s \\
\hline SONY MICRO VAULT TINY    &  1.89~GiB & 6~m~27~s \\
\hline SP Silicon Power 16GB    & 15.00~GiB & 4~m~26~s \\
\hline LaCie                    & 15.10~GiB & 2~m~08~s 
            \end{tabular}
        \end{table}
