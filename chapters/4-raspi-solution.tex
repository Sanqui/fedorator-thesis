    ...
    \section{Software}
        ...
        \subsection{Behavior}
            ...
            \screenshotfigure{fedorator-screenshot-done.png}
                {Fedorator: Fedora LXDE Destkop was sucessfully written to the flash drive \todo{Replace the screenshot with one that says "drive" if there's time.}}
