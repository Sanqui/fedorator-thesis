\label{Introduction}
    ...
    \section{How Fedora Spreads Publicity}
        ...
        \todo{These are the people who may make a Fedorator, they don't have to be developers, they may be involved in other ways, e.g. translators}
        \blind[3]
    \section{Existing solutions}
        ...
        \subsection{Existing software}
            ...
            \subsubsection{Fedora Media Writer}
                ...
                Fedora Media Writer is written in C++ using the Qt framework and supports Linux, Windows, and macOS.
