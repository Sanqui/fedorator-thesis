\label{Introduction}
    ...
    \section{How Fedora Spreads Publicity}
        ...
        In the Czech Republic, Fedora holds stands on events such as Linux Days\cite{linux-days}, InstallFest\cite{install-fest}, or PyCon CZ\cite{pycon-cz}.  An Ambassador's task at the stand might be to set it up, bring out the merchandise, and then speak with visitors, who may be familiar with Fedora and have questions, or have never heard about it before.
    ...
    \section{Existing solutions}
        ...
        \subsection{Preloaded USB flash drives}
            ...
            For a bit of perspective, the price for 500 replicated DVDs come down to 0.88~USD (about 22~CZK) for one DVD\quote{discmakers-quoter}.  We can see USB flash drives are over four times as expensive.
    ...
    \section{Rationale for a New Solution}
        ...
        \begin{itemize}
            ...
            \item It may not be as compatible, or "battle tested" as commercial solutions.\todo{FOOTNOTE}
