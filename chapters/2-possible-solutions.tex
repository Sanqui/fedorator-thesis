\chapter{Analysis of Possible Solutions}
    ...
    \textbf{Long term maintainability}.  Fedora receives new releases approximately every six months\cite{fedora-release-life-cycle}, it is therefore necessary that the Fedorator is capable of keeping up with the times.
    ...
    \section{Other Component Options}
        ...
        However, each component increases the difficulty of assembly, as it imposes the necessity of buying the component, as well as of connecting it properly and seating it in place. 
