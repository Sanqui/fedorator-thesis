\chapter{Analysis of Possible Solutions}
    ...
    \section{Casing Options}
        ...
        \subsection{3D printed}
            ...
            \todo{ABS/PLA (we used PLA)}
    \section{Roundup}
        For the \textbf{CPU}\todo{Not the right term, I want to keep saying "heart" or "brain"} of the device, I deem two distinct categories based on form factor.
    ...
    \section{Concepts}
        ...
        \todo{At the end, check if there should be a linebreak here or not for stylistic reasons.}
        \pagebreak
